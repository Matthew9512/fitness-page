...
export const renderPagination = (numOfPages) => {
  ...
  if (state.page === 1 && numOfPages > 1) {
    return `
      <div class="btns">
        ...
        <button class="btn btn-next">Page ${state.page + 1} <i class="fa-solid fa-arrow-right"></i></button>
      </div>`;
  }
  // im on page other than first and last
    ...
    return `
      <div class="btns">
        <button class="btn btn-prev"><i class="fa-solid fa-arrow-left"></i> Page ${state.page - 1}</button>
        <button class="btn btn-next">Page ${state.page + 1} <i class="fa-solid fa-arrow-right"></i></button>
      </div>`;
  }
  // im on last page
